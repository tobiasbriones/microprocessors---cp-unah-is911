...
.com/tobiasbriones/cp-unah-is911-microprocessors}{GitHub Repository}.}
    ...
    Algunos tipos de sockets, por mencionar, tenemos
    \cite{authortechnews-2020}: TR4, AM4, LGA 1151, 2066, sTRX4. Al momento
    ...
    \begin{displayquote}
        ...
        de inglés a español) \cite{university-information-technology-services
        -2019}
    \end{displayquote}
    ...
    \begin{figure}[H]
        ...
        Fuente: Imágen por \href{https://pixabay
.com/users/bru-no-1161770}{Bruno /Germany} de \href{https://pixabay
.com}{Pixabay} \cite{pixabay-cpu-socket-2019}.
    \end{figure}
