...
\begin{document}
    ...
    Los GALs (cuales nos interesa) son útiles para prototipos y una mejora de los PAL. GAL significa \say{Dispositivo de Lógica de Arreglo Genérico}. Y su forma física es como la siguiente:
