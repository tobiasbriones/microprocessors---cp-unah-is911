...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \say{DLLs} o \say{LIBs} en páginas de internet lo cual es algo
        ...
        \item licencias ridículamente caras y la versión de prueba no deja
        \item guardar (para entregar la tarea por ejemplo). Esto es muy común
        \item con software del siglo pasado como todos esos que usan los
        \item matemáticos que no saben computación y pagan licencias
        \item propietarias innecesarias. Proteus usa QT (ni hablar del tipo
        \item de código ofuscado y malo escrito en C++ del viejo como la
        \item aplicación de escritorio de Telegram que es de código abierto
        \item pero está escrita en C++ con QT \footnote{La aplicación de
        \item Telegram de escritorio esta hecha por la comunidad de código
        \item abierto y escrita en C++ con QT bajo la licencia GPL
        \item \href{https://github.com/telegramdesktop/tdesktop}{Telegram
        \item Desktop Github}}), el asunto es que la firma paga licensias a
        \item QT para obtener una licencia comercial para usar QT sin liberar
        \item el código de Proteus \footnote{La licensia GPL que provee QT es
        \item una licensia copyleft por lo cual se \say{viraliza} y el
        \item usuario debe liberar el código fuente de su programa también} y
        \item entonces no estar bajo la licencia GPL de QT por lo cual el
        \item usuario final termina pagando este tipo de estupideces cuando
        \item hay mejores plataformas y de más alto nivel y de alto
        \item rendimiento aún como JavaFX o incluso Java Swing o Web Assembly
        \item los cuales permiten desplegar software propietario y más usable
        \item tanto para los desarrolladores como el usuario. Comparar eso a
        \item software moderno que se usa en ingeniería o desarrollo de
        \item software como los productos de Microsoft, JetBrains o Google.
        \item Parece que todo ese dinero de las licencias propietarias no
        \item sirve para mejorar el producto por lo cual debemos apoyar el
        \item código abierto que está respaldado por organizaciones
        \item comprometidas.
